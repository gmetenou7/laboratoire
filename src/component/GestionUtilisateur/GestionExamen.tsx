...
const GestionExamen = () => {
  ...
  const [examen, setFamilExam]= useState('');
 ...
 const changePage =(event: any)=>{
  ...
  /***Afficher la liste des examens en registrer */
  ...
  const onShowPatient = async ()=>{
    ...
    let token= await getAppToken()
      ...
      setPageNumber(typeof pageNumber === "object" ? (pageNumber as any).selected : pageNumber) 
  ...
  /***Recuperer le matricule du labo et de l'employé afin de créer un examen */
   ...
   // setReload(true)
		...
		let registerClient={
		  ...
		  if(token){
			...
			localStorage.setItem('Apitoken', token)
			let response= await callApi(true, 'client', 'post', null, registerClient)
			console.log(response)
...
<Modal
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Créer un Examen</Modal.Title>
        </Modal.Header>
        ...
        <Form onSubmit={handleCreate}>
          ...
          <Row>
           ...
           <Form.Label>Famille d'Examen</Form.Label>
              <Form.Control
                ...
                id='famille'
                value={examen}
                onChange={(e)=>setFamilExam(e.target.value)}
                placeholder="familleExam"
                autoFocus
              />
          </Form.Group>
            </Col>
          ...
          <Row >
          <Col xs={6} md={4} >
          <Button variant="danger" className="mb-3"  onClick={handleClose3}>
                Annuler 
                </Button>
          </Col>
              ...
              <Col xs={6} md={4} style={{justifyContent: "space-between"}} >
                <span></span>
                <Button variant="primary" type='submit' className="mb-3" style={{marginLeft: "150px"}}>
                Créer 
                </Button>
              </Col>
          </Row>
...
{/* /***Views user information */ }
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Informations sur l'examen</Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <div className="col">
                            <div className="row">
                                ...
                                <div className="col-12 mt-2">Téléphone : {selectPatient.telephone}</div>
                                <div className="col-12 mt-2">date de naissance : {selectPatient.datenaissance}</div>
                                <div className="col-12 mt-2">Lieu de naissance : {selectPatient.lieunassance}</div>
                                <div className="col-12 mt-2">Nationalité : {selectPatient.nationalite}</div>
                                <div className="col-12 mt-2">Lieu de residence : {selectPatient.lieuvie}</div>
                                <div className="col-12 mt-2"> sexe : Feminin</div>
                                <div className="col-12 mt-2"> Personne à contacter : {selectPatient.personneurgence}</div>
                                <div className="col-12 mt-2"> Tel Personne à contacter : {selectPatient.telpersonneurgence}</div>
...
<Modal
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Modifier les Informations d'un Examen</Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <Form>
      ...
      <div className="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content"></div>                 
        ...
        <div className="kt-portlet__head kt-portlet__head--lg">
          <div className="kt-portlet__head-label">
            <h3 className="kt-portlet__head-title">Liste des Examens
              <small></small>
            </h3>
          </div>
            ...
            <div className="row align-items-center">				
              <div className="col-md-4 kt-margin-b-20-tablet-and-mobile">
                <div className="kt-input-icon kt-input-icon--left">
                  <input type="text" className="form-control" placeholder="Rechercher  le code ou le nom..." id="generalSearch"/>
              ...
              <div className="col-md-4 kt-margin-b-20-tablet-and-mobile">
                <button className='btn btn-primary' style={{marginLeft: "100px"}} onClick={handleShow3}>Nouvel Examen</button>
              </div>
             </div>
          </div>
        ...
        <div className="kt-portlet__body kt-portlet__body--fit">
          ...
          <div className="kt_datatable kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded" id="local_data">
            ...
            <thead className="kt-datatable__head"><tr className="kt-datatable__row" style={{left: "0px"}}>
                  ...
                  <th data-field="hire_date" className="kt-datatable__cell kt-datatable__cell--sort" >
                    <span style={{width: "110px"}}>Famille d'Examen</span>
                  </th>
                  ...
                  {filtrePatient.map((key:any)=>{
                      ...
                      <tr data-row="0" className="kt-datatable__row" style={{left: "0px"}}>
                        ...
                        <td className="kt-datatable__cell--center kt-datatable__cell kt-datatable__cell--check" data-field="id">
                          ...
                          <span style={{width: "110px"}}>{key.matricule}</span>
                        </td>
                        <td data-field="name" className="kt-datatable__cell" >
                          <span style={{width: "110px"}}>{key.nom}</span>
                        </td>
                        <td data-field="hire_date" className="kt-datatable__cell" >
                          <span style={{width: "110px"}}>{key.telephone}</span>
                        </td>
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" className="kt-datatable__cell">
                          <span style={{overflow: "visible", position: "relative", width: "120px"}}>
                               ...
                               <a title="visualiser" className="btn btn-icon btn-circle btn-label-facebook" onClick={handleShow}>
                                <i className="far fa-eye "></i>
                              </a> 
                              <a title="Modifier" className="btn btn-icon btn-circle btn-label-twitter" onClick={handleShow1}>
                                <i className="fas fa-pencil-alt"></i>
                              </a> 
                              <a title="Désactiver" className="btn btn-icon btn-circle btn-label-linkedin" onClick={handleShow2}>
