...
export function StatAssuranceCompany() {
            ...
            <div className="services-list ">
                <form 
                    ...
                    <div className="input-group">
                        <label className="label" htmlFor="id-service"> Choisisser une entreprise
                        ...
                        >
                            ...
                            <option >Export Express</option>
                            <option >Security IT</option>
                            <option >Issis hotel</option>
                        </select> 
                    </div>
                    <InputField
                        id="datedebut"
