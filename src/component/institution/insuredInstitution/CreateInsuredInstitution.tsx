...
export const CreateInsuredInstitution = () => {
    ...
    async function handleCreateContract(data: InsuredContractInstitution) {
        ...
        try {
            const response = await dispatch(createAssuranceContratThunk(data))
        ...
        <Fragment>
            <form onSubmit={handleSubmit(handleCreateContract)}>
                ...
                <div className="btn-group">
                    ...
                    <Link
                        to={`/list-contrat-institution/:code`}
                        type="button"
